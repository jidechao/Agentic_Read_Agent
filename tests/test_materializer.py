...
def _setup_docs_and_clusters(registry: KnowledgeRegistry) -> tuple[int, dict[str, str]]:
    """Create sample docs and clusters in registry, return (compile_run_id, short_doc_texts)."""
    # Short doc
